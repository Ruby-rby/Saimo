...
class MonoDETR(nn.Module):
    ...
    def forward(self, images, calibs, targets, img_sizes, dn_args=None):
        ...
        for lvl in range(hs.shape[0]):
            ...
            # print(f"zl-tst  reference.shape[-1]:{reference.shape[-1]}")
            ...
            # print(f"zl-tst  reference:{reference[0]}")
        ...
        # print(f"zl-tst  out['pred_boxes']:{out['pred_boxes'].shape}  {out['pred_boxes'][0]}")
