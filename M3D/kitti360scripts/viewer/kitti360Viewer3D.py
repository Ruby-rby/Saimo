...
class Kitti360Viewer3D(object):
    ...
    def __init__(self, seq=0, showStatic=True):
        ...
        self.cmap = matplotlib.cm.get_cmap('Set1')  # zltst
        self.cmap_length = 9 
        # colormap for confidence
        self.cmap_conf = matplotlib.cm.get_cmap('plasma')  # zltst
        ...
        self.annotation3D = Annotation3D(self.label3DBboxPath, sequence) # zltst
    ...
    def assignColor(self, globalIds, gtType='semantic'):
        ...
        color = color.astype(np.float16)/255.0 # zltst 16
        return color
...
if __name__=='__main__':
    ...
    #                             help='The modality to visualize')  # zltst
    parser.add_argument('--mode', choices=['rgb', 'semantic', 'instance', 'confidence', 'bbox'], default='bbox',
